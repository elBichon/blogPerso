...
<?php
    ...
    if($iphone || $ipad || $android || $blackberry > -1){
        header('Location: http://localhost/sprint/accueilMobile.php'); // si c'est le cas, on redirige
    ...
    <body>
        <header>
            ...
            <?php  include("includes/aside.php"); ?>
                <ul>
                    <li><h3 id="moi"><img src="images/qui.png" alt="moi" id="moi" width=20px/>  Qui suis-je ?</h3></li>
